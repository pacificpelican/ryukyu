...
var ryukyu_listItem = function() {
  ...
  return ($traceurRuntime.createClass)(linkedListItem, {}, {});
}();
var ryukyu_list = function() {
  ...
  return ($traceurRuntime.createClass)(listNode, {}, {});
}();
...
var $ryukyu = function ryukyu(feature, payload) {
  ...
  if (feature == "insertionSort") {
    var insertionSortSpotFinder = function(set, x) {
    ...
    var insertionSortDepthFinder = function(set, x) {
    ...
    var implementInsertionSort = function(zs1, place, distance) {
      var tempe = zs1[place];
